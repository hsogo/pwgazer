...
if __name__ == '__main__':
    ...
    marker_size = screen_size[1] * 0.01
    target_size = screen_size[1] * 0.03
    
    win = psychopy.visual.Window(size=screen_size, units='pix', monitor=monitor, fullscr=fullscr)
    probe = psychopy.visual.Rect(win, width=marker_size, height=marker_size)
    probe_L = psychopy.visual.Rect(win, width=marker_size, height=marker_size, fillColor='blue', lineColor='blue')
    probe_R = psychopy.visual.Rect(win, width=marker_size, height=marker_size, fillColor='red', lineColor='red')
    square_stim = psychopy.visual.Rect(win, width=target_size, height=target_size, fillColor=None, lineColor='lime')
    ...
    try:
        ...
        dlg.addText('<b>python -m pwgazer.app.RealtimeTracker</b>')
