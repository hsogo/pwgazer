...
class results_dlg(wx.Dialog):
    ...
    def copy_to_clipboard(self, evt):
        if wx.TheClipboard.Open():
            ...
            wx.MessageBox('Parameters are copied to the clipboard.\nPaste them before closing this dialog.','Info')
            self.parent.Show()
...
class fullscreen_cross(wx.Frame):
    def __init__(self, parent=None, id=wx.ID_ANY, title=''):
        ...
        button_cancel = wx.Button(panel, wx.ID_ANY, label='Close', pos=(164,288))
